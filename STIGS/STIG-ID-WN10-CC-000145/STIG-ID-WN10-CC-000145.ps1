...
# PowerShell script to require password on resume from sleep (on battery)
...
Write-Host "Password prompt on resume from sleep (on battery) has been enforced successfully."
